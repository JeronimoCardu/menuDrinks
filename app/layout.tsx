...
export const metadata: Metadata = {
  ...
  description: 'Tragos, combos y promociones exclusivas. Escaneá el QR y explorá nuestra carta.',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="es" className={`${inter.variable} ${bebasNeue.variable}`}>
      <body className="font-body bg-night-bg min-h-screen">{children}</body>
    </html>
  );
}
